...
var VtrTrivia = function() {
    ...
    if(resultados.length > 0) {
        ...
        function updateSocialSharing() {
            ...
            var facebookShareUrl = 'http://www.facebook.com/sharer.php?s=100&p[url]=https://vtreslollacl.cl/lollaquiz/resultado?respuestascorrectas=' + correctAnswers;
            var twitterShareUrl = 'https://twitter.com/intent/tweet?text=' + customMessage + '&url=https://vtreslollacl.cl/lollaquiz/resultado?respuestascorrectas=' + correctAnswers;
    ...
    if (preguntas.length > 0) {
        ...
        function nextQuestion(colors) {
            ...
            if (currentQuestionIndex < questions.length - 1) {
                ...
                window.location.href = '/lollaquiz/resultado?respuestascorrectas=' + correctAnswers;
